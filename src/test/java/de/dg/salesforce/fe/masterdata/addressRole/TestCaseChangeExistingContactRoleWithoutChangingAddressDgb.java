...
public class TestCaseChangeExistingContactRoleWithoutChangingAddressDgb extends Page {
    ...
    public void tcChangeExistingContactRoleWithoutChangingAddressDgb() {
        ...
        masterData.selectContact("Billing");
        ...
        cimAccountViewPage.verifyIfAddressContains(fullAddress);

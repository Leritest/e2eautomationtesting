...
public class TestCaseDeactivateAContactWithoutRolesDgh extends Page {
    ...
    String accountId = "3941736";

    /**
     * <b>[Test Method]</b> - Test Case Deactivate A Contact Without Roles Dgb<br>
     * <br>
     ...
     * 2. ???????
     */
    @Test(description = "OPT-5585")
    public void tcDeactivateAContactWthoutRolesDgh() {
        ...
        masterData.selectContactToDeactivate(contactNameNoSalutation);
        ...
        masterData.verifyInactiveContactNewValue(true);
        ...
        contactViewPage.verifyInactiveContactStatus(true);

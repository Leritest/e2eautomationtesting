...
public class TestCaseChangeCompanyNameDgh extends Page {

    Random rand = new Random();
    List<CaseData> caseDataList = new ArrayList<>();
    CaseData caseData1 = new CaseData();
    String randomNumber = String.valueOf(rand.nextInt(1000));
    String accountId = AccountAPI.addNewAccountInCIM("DGH");
    ...
    public void tcChangeCompanyNameDgh() {
        ...
        String newCompanyName = "ASDGH01"+randomNumber;

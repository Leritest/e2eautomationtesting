...
public class TestCaseWithVoiceRecordingAndEmailForConnectionOwnerRoleDgb extends Page {
    ...
    public void tCWithVoiceRecordingAndEmailForConnectionOwnerRoleDgb() {
        ...
        cimAccountViewPage.verifyIfOptinIsShownInNotizen(true);
        cimAccountViewPage.clickOptinGeandert();
        cimAccountViewPage.verifyNotizenOptin("Telefon");
        cimAccountViewPage.verifyNotizenOptin("Email");
        cimAccountViewPage.verifyNotizenOptin("Verkehrsdaten");

...
public class TestCaseChangeExistingContactRoleAndNewAddressDgb extends Page {
    ...
    public void tcChangeExistingContactRoleAndNewAddressDgb() {
        ...
        String contactFullName = "Aleksandar StojanovBilling";

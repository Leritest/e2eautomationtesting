...
public class TestCaseNamensanderungWeitereKontakteDgb extends Page {
    ...
    public void tcNamensanderungWeitereKontakteDgb() {
        ...
        String caseNumber = "00023463";
        String randomNumber = String.valueOf(rand.nextInt(1000));
        String lastNameNew = "StojanovBilling" + randomNumber;

...
public class TestCaseChangeOnlyCompanyNameNew extends Page {
    ...
    public void tcChangeOnlyCompanyNameNew() {
        ...
        String caseNumber = "00023877";
        String newCompanyName = "ASNEW01"+randomNumber;

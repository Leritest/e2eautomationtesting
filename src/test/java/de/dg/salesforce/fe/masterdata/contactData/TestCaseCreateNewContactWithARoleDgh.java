...
public class TestCaseCreateNewContactWithARoleDgh extends Page {
    ...
    public void tcCreateNewContactWithARoleDgh() {
        ...
        //masterData.verifyIfLastNameErrorWhenCreatingNewContactIsShown();
        //masterData.createNewContact(tLastName);
        ...
        //masterData.verifyTypFieldValue("Bevollmächtigter");//commented because it fails on this step

...
public class TestCaseLastNameEmptyNew extends Page {

    List<CaseData> caseDataList = new ArrayList<>();
    CaseData caseData1 = new CaseData();
    String accountId = AccountAPI.addNewAccountInCIM("NEW");
    ...
    public void tcLastNameEmptyNew() {

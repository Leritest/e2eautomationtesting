...
/**
 * <b>End2End Feature : DGH ISP Type Suite</b> Activate Legacy Customer List<br>
 *  <i>Class functionality:</i><br>
 *  Class is used to define end2end test suite<br>
 *  regarding activation of customer list <br>
 *  on Legacy Portfolio for DGH type
 */
@Listeners(automation.listeners.ExtentListeners.class)
public class TestSuiteE2eActivateLegacyCustomerListDghIspType {
    ...
    @Test
    public void tcE2eActivateCustomerPortfolioLegacyDghIspType() {
        cupool = new ArrayList<>();

        Portfolios portfolio = Portfolios.Legacy;
        ...
        int tariff = 100;
        customerCreation(repeat, portfolio, tariff, router, waipu);
    ...
    public void customerCreation(int repeat, Portfolios portfolio, int tariff, RouterTypes router, WaipuTypes waipu) {
        for (int i=0; i<repeat; i++) {
            initTestingResource(portfolio, tariff, router, waipu);
    ...
    public void initTestingResource(Portfolios portfolio, int tariff, RouterTypes router, WaipuTypes waipu) {
        // set first name
        ...
        // set company name
        String firmaName = StaticContext.generateRandomFirmaName();
        PostCreateCustomer.setCompanyName(firmaName);
        PostCreateCustomer.setFirmaCheck();
